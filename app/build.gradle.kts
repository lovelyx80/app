...
android {
    ...
    defaultConfig {
        ...
        versionCode = 149
        versionName = "13.6.0"
        resValue("string", "app_name", appNameOverride ?: "Lovely Beats")
    ...
    productFlavors {
        // FOSS - no gcast, updater disabled
        create("foss") {
            dimension = "variant"
            isDefault = true
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Lovely Beats Debug")
            }
            signingConfig =
