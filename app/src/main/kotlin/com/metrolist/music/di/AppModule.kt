...
/**
 * Returns the shared/public "Music/Metrolist" download folder
 * (visible to file managers, e.g. Android/data/com.metrolist.music/files/Music/Metrolist),
 * falling back to internal storage if external storage isn't available.
 */
private fun resolveDownloadDir(context: Context): File {
    ...
    val targetDir = if (externalMusicDir != null) {
        File(externalMusicDir, "Metrolist")
    } else {
